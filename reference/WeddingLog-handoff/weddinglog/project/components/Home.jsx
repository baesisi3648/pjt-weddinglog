// Home screen — WeddingLog
// Mobile frame shown as mockup inside desktop canvas
...
function Home() {
  ...
  const toggleTask = (id) =>
    setTasks(function (t) { return t.map(function (x) { return x.id === id ? Object.assign({}, x, { done: !x.done }) : x; }); });
        ...
        <div className="wl-hero">
          ...
          <div className="wl-hero-inner">
            ...
            <div className="wl-dday">
              ...
              <span className="wl-dday-num">D-42</span>
            </div>
            <div className="wl-wedding-date">2025. 10. 25 · SAT</div>
...
function BottomNav({ active }) {
  const items = [
    ...
    { id: "timeline", label: "타임라인", icon: <IconTime /> },
    { id: "album", label: "앨범", icon: <IconBook /> },
    { id: "settings", label: "설정", icon: <IconGear /> },
  ];
  return (
    <nav className="wl-bottomnav">
      {items.map((i) => (
        <div key={i.id} className={`wl-nav-item ${active === i.id ? "is-active" : ""}`}>

...
function CalendarScreen() {
  const [selected, setSelected] = useStateC(15);
  const [events, setEvents] = useStateC(WL_EVENTS);
      ...
      <div className="wl-scroll">
        ...
        <div className="wl-day-events">
          ...
          <div className="wl-events-list">
            {selDayEvents.map((e) => (
              <div key={e.id} className={`wl-event ${e.done ? "is-done" : ""}`}>

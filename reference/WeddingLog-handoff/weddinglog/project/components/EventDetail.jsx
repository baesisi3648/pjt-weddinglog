// Event Detail / Edit screen — WeddingLog
...
function EventDetail() {
  ...
  const [activePhoto, setActivePhoto] = React.useState(2);
  ...
  return (
    <div className="wl-page">
      ...
      <div className="wl-page-topbar">
        <button className="wl-icon-btn wl-back-btn">
        ...
        <main className="wl-detail-right">
          <div className="wl-section-head wl-section-head-plain">
            ...
            <div className="wl-photos-summary">
              ...
              <span className="wl-photos-added">최근 추가 2분 전</span>
            </div>
          </div>

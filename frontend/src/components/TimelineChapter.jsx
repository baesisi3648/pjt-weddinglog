...
// @TEST src/components/TimelineChapter.test.jsx
 ...
 */
function InlineCaptionEditor({ caption, photoId, onSave }) {
 ...
 * @param {{ chapter: object, onSelectionChange: Function }} props
 */
export default function TimelineChapter({ chapter, onSelectionChange }) {

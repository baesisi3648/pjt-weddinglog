...
// @TEST src/components/CoupleProfileCard.test.jsx
 ...
 */
function SecondaryCountdown({ album_order_deadline }) {
  ...
  return (
    ...
    >
      {isExpired ? (
        ...
        <span>
          앨범 주문 추천: D-{Math.abs(days_remaining)}
        </span>
      )}
    </div>
  );
 ...
 * @param {{ couple: object, album_order_deadline: object }} props
 */
export default function CoupleProfileCard({ couple, album_order_deadline }) {

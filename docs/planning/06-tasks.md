...
### [x] P3-R1-T2: PhotoService (파일 저장 + DB 관리)
...
### [x] P3-S1-T4: CaptionSelector 컴포넌트
...
### [x] P3-V1 (수동 체크리스트): Photo & EventDetail E2E
